...
export default function Login() {
  ...
  return (
    <div style={{minHeight:'100vh', position:'relative', overflow:'hidden', background:'linear-gradient(135deg, #f8fafc 0%, #fff 40%, #f1f5f9 100%)'}}>
      ...
      <img aria-hidden src="/images/line-dog.svg" style={{position:'absolute', left:'5%', top:'18%', width:160, opacity:.8, filter:'drop-shadow(0 0 20px rgba(37,99,235,.15))', pointerEvents:'none'}} />
      <img aria-hidden src="/images/line-cat.svg" style={{position:'absolute', right:'8%', bottom:'12%', width:140, opacity:.8, filter:'drop-shadow(0 0 20px rgba(5,150,105,.15))', pointerEvents:'none'}} />
      ...
      <div className="container-app" style={{display:'grid', placeItems:'center', minHeight:'100vh', position:'relative', zIndex:1}}>
        ...
        <div style={{position:'relative', width:'100%', maxWidth:430, padding:28, borderRadius:20, border:'1px solid rgba(255,255,255,0.45)', background:'linear-gradient(180deg, rgba(255,255,255,0.65), rgba(255,255,255,0.35))', boxShadow:'0 30px 80px rgba(37,99,235,0.15), 0 6px 18px rgba(0,0,0,0.05)', backdropFilter:'blur(10px)'}}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{display:'flex', alignItems:'center', gap:8, border:'1px solid #e2e8f0', borderRadius:12, padding:'12px 14px', background:'#fff', boxShadow:'inset 0 0 0 1px rgba(37,99,235,0.08)'}}>
            ...
            <div style={{display:'flex', alignItems:'center', gap:8, border:'1px solid #e2e8f0', borderRadius:12, padding:'12px 14px', background:'#fff', boxShadow:'inset 0 0 0 1px rgba(5,150,105,0.06)'}}>
            ...
            {/* Botones */}
            <button type="submit" className="btn-primary" style={{width:'100%', marginTop:18, padding:'12px 18px', background:'linear-gradient(90deg, #2563eb, #3b82f6, #1d4ed8)', backgroundSize:'200% 100%', animation:'gradientMove 4s ease infinite'}}>
              Iniciar Sesión
            </button>
          </form>
          <Link to="/register" style={{display:'block', textAlign:'center', marginTop:12, textDecoration:'none'}}>
            <button className="btn-ghost" style={{width:'100%', borderColor:'rgba(37,99,235,0.45)'}}>Registrarse</button>
          </Link>
